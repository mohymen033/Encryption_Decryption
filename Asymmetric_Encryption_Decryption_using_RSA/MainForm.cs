	...
	public class MainForm : Form
    {
		...
		public MainForm( string fileName )
		{
			...
			if( File.Exists( fileName ) )
			{
				...
				streamReader.Close();
                this.Text = GetFileName(fileName) + " - Asymmetric Encription_Decription Pad";
				cleanForm = true;
			}
		}
		...
		private void InitializeComponent()
		{
            ...
            // encryptionMenuItem
            // 
            this.encryptionMenuItem.Index = 1;
            ...
            this.encryptionMenuItem.Text = "Encryption/Decryption";
            // 
            // encryptMenuItem
            // 
            ...
            this.Text = "Asymmetric Encription_Decription Pad";
		...
		private string openFile( string title, string filterString )
		{
			...
			if( openFileDialog.ShowDialog() == DialogResult.OK )
			{
				if( File.Exists( openFileDialog.FileName ) )
				{
					...
					if( fileString != null )
					{
						this.Text = GetFileName( openFileDialog.FileName ) + " -AsymmetricPad";
		...
		private bool saveFile()
		{
			...
			if( saveFileDialog.ShowDialog() == DialogResult.OK )
			{
				try
				{
					...
					streamWriter.Close();
                    this.Text = GetFileName(saveFileDialog.FileName) + " - Asymmetric Encription_Decription Pad";
		...
		private void mainForm_Load( object sender, EventArgs e )
		{
            ...
            this.Text = GetFileName(currentFileName) + " - Asymmetric Encription_Decription Pad";
			inputTextBox.Focus();
		...
		private void mainForm_FormClosing( object sender, FormClosingEventArgs e )
		{
			...
			if( !cleanForm )
			{
                ...
                switch (MessageBox.Show(dialogText, "Asymmetric Encription_Decription Pad", MessageBoxButtons.YesNoCancel))
				{
		...
		private void inputTextBox_DragDrop( object sender, DragEventArgs e )
		{
			...
			if( clean )
			{
				if( e.Data.GetDataPresent( DataFormats.FileDrop, true ) == true )
				{
                    ...
                    this.Text = GetFileName(fileNames[0]) + " - Asymmetric Encription_Decription Pad";
					...
					case DialogResult.Yes:
						{
							if( saveFile() )
							{
                                ...
                                this.Text = "Untitled - Asymmetric Encription_Decription Pad";
								cleanForm = true;
							}
							break;
						}
